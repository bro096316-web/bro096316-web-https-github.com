...
# Bot information
API_ID = environ.get('API_ID', '29124838')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'd1a293f6fc4c87f59a665f0a68cd607b') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-1002520793005") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', 'https://t.me/movies_updet').split()]
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', 'https://t.me/Your_Movie_Link_8') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://ABHI:ABHI@cluster0.h1ewpln.mongodb.net/?appName=Cluster0") #mongo db url
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://files.catbox.moe/o0y8tz.jpg') #telegraph link of your QR code 
