...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002520793005') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://surekaptan1_db_user:EPIBRqiHQpWvbRXn@cluster0.bahczql.mongodb.net/?appName=Cluster0") #mongo db url
if len(DATABASE_URL) == 0:
    print('Error - DATABASE_URL is missing, exiting now')
    exit()
DATABASE_NAME = environ.get('DATABASE_NAME', "surekaptan1")
